...
namespace Dypsloom.DypThePenguin.Scripts.Game
{
    ...
    public class NicePenguin : MonoBehaviour
    {
        ...
        [Tooltip("The interaction SFX.")]
        [SerializeField] protected AudioSource m_SfxInteract;
        [Tooltip("The completed SFX.")]
        [SerializeField] protected AudioSource m_SfxCompleted;
