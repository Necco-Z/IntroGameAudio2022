...
namespace Dypsloom.DypThePenguin.Scripts.Items
{
    ...
    public class SwingAttack : ItemActionComponent, IDamager
    {
        ...
        [Tooltip("The Sfx for swinging the pickaxe.")]
        [SerializeField] protected AudioSource m_SfxSwing;
        [Tooltip("The Sfx for hitting something.")]
        [SerializeField] protected AudioSource m_SfxHit;
