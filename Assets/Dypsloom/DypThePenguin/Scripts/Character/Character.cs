...
namespace Dypsloom.DypThePenguin.Scripts.Character
{
    ...
    public class Character : MonoBehaviour
    {
        ...
        [Tooltip("Death Sfx.")]
        [SerializeField] protected AudioSource m_SfxDefeat;
        [Tooltip("Jump SFX.")]
        [SerializeField] protected AudioSource m_SfxJump;
        ...
        [HideInInspector] public CharacterWalkSfx SfxWalk;
        public AudioSource SfxJump => m_SfxJump;
        ...
        protected virtual void Awake()
        {
            ...
            SfxWalk = GetComponent<CharacterWalkSfx>();
