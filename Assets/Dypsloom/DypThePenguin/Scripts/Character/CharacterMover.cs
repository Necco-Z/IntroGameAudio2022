...
namespace Dypsloom.DypThePenguin.Scripts.Character
{
    ...
    public class CharacterMover : ICharacterMover
    {
        ...
        protected AudioSource m_SfxJump;
        protected CharacterWalkSfx m_SfxWalk;
        ...
        public CharacterMover(Character character)
        {
            ...
            m_SfxJump = m_Character.SfxJump;
            m_SfxWalk = m_Character.SfxWalk;
        ...
        public void Tick()
        {
            ...
            if (m_CharacterInputMovement != new Vector3(0f, 0f, 0f) && m_Character.IsGrounded)
            {
                m_SfxWalk.Play();
            } else {
                m_SfxWalk.Stop();
