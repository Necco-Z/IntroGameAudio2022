...
namespace Dypsloom.DypThePenguin.Scripts.Character
{
    ...
    public class CharacterInteractor : MonoBehaviour, ICharacterInteractor
    {
        ...
        [Tooltip("This sound is played when the character can interact with something.")]
        [SerializeField] protected AudioSource m_SfxInteractable;
        [Tooltip("This sound is played when the character gets an item.")]
        [SerializeField] protected AudioSource m_SfxGetItem;
        ...
        public void AddInteractable(IInteractable interactable)
        {
            ...
            if (m_Interactables.Count > 0) {
                ...
                m_SfxInteractable.Play(); /// Exclamation sound
            }
